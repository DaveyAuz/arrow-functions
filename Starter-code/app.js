...
// When joe.scope() is invoked, "this" refers to the instance of the Student object "joe".
// 2. What is "this" when joe.scopeArrow() is invoked?
// When joe.scopeArrow() is invoked, "this" refers to the global object, which is the window object in the browser or the global object
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions do not have their own "this" binding, and instead, "this" is determined lexically by the scope in which the arrow function is defined. In this case, the arrow function is defined outside of the constructor function, so it does not have access to the instance of the object and instead refers to the global object.